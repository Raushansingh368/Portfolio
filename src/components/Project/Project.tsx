          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Raushansingh368/angular-e-commerce-.git" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="GitHub" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>E-commerce Website for Online Shopping</h3>
              <p>
              Developed a responsive e-commerce website using Angular.js  integrating features like product listing, user authentication, shopping cart, and checkout functionality. Implemented secure payment gateway integration and optimized UI/UX for better user engagement, ensuring scalability and enhanced performance for online shopping experiences.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Raushansingh368/react-e-commerce.git" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>E-commerce Website for Online Shopping </h3>
              <p> Developed a responsive e-commerce website using React.js  integrating features like product listing, user authentication, shopping cart, and checkout functionality. Implemented secure payment gateway integration and optimized UI/UX for better user engagement, ensuring scalability and enhanced performance for online shopping experiences. </p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>ANGULAR. JS</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/Raushansingh368/Angular-chatbot-project.git" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
                <a href="https://chat-omega-orpin.vercel.app/" target="_blank" rel="noreferrer">
          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                ...
                <a href="https://github.com/Raushansingh368/first.git" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>Interactive Card Game
              </h3>
              <p>Developed a simple and engaging card game using HTML, CSS, and JavaScript, featuring dynamic card flipping, score tracking, and game reset functionality. Focused on responsive design and smooth animations to enhance user experience.
